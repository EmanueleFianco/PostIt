...
--
-- Host: localhost
-- Generation Time: Giu 12, 2015 alle 22:39
...
) ENGINE=InnoDB AUTO_INCREMENT=7273 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `utente` (
  ...
  `id_immagine` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `nome` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
